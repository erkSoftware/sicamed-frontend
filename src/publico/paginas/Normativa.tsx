...
const NORMAS = [
  {
    ...
    articulos: [
      { numero: "Art. 3.7", texto: "La consulta de la vitrina es pública y no requiere autenticación." },
      { numero: "Art. 8c", texto: "La habilitación del canal de contacto entre actores no constituye una transacción comercial." },
      { numero: "Art. 13b", texto: "No se publica oferta alguna sin atestación de licencia vigente para el tipo de producto." },
      { numero: "Art. 21", texto: "Las cantidades y la capacidad productiva son información reservada de carácter comercial." },
      { numero: "Art. 24", texto: "Los datos clínicos y los comerciales se administran en zonas separadas e independientes." },
    ],
  },
  {
    id: "ley-1712",
    ...
    articulos: [
      ...
      { numero: "Art. 4", texto: "Toda persona puede acceder a la información pública sin necesidad de justificar su solicitud." },
    ],
  },
  {
    id: "ley-1581",
    ...
    articulos: [
      ...
      { numero: "Art. 6", texto: "Se prohíbe el tratamiento de datos sensibles salvo las excepciones expresamente previstas." },
    ],
  },
];
...
export const Normativa = () => (
  <div className="contenedor" style={{ paddingBottom: "var(--e8)" }}>
    <Seo
      ...
      ruta="/normativa"
      palabrasClave={["normativa cannabis medicinal Colombia", "Resolución 1241 de 2026", "Ley 1712 de 2014"]}
      datosEstructurados={[
        migasJsonLd([
          { nombre: "Inicio", ruta: "/" },
    ...
    <div className="prosa" style={{ maxWidth: "none" }}>
      {NORMAS.map((norma) => (
        <section key={norma.id} id={norma.id} className="tarjeta" style={{ marginBottom: "var(--e5)" }}>
