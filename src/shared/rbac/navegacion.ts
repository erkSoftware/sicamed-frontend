...
export const NAVEGACION: readonly ItemNavegacion[] = [
  ...
  { ruta: "/app/cupos", etiqueta: "Cupos asignados", permiso: "produccion:cupo:leer", grupo: "CUMPLIMIENTO", modulo: "cultivo", icono: "escudo", zona: "comercial", descripcion: "Cupo de plantas del MICC y su ocupación real" },
  ...
  { ruta: "/app/transformacion", etiqueta: "Transformación", permiso: "produccion:transformacion:leer", grupo: "GESTIÓN", modulo: "inventario", icono: "capas", zona: "comercial", descripcion: "Biomasa a producto terminado con registro sanitario" },
  ...
  { ruta: "/app/solicitudes", etiqueta: "Solicitudes de registro", permiso: "cumplimiento:solicitud:tramitar", grupo: "CUMPLIMIENTO", modulo: "cumplimiento", icono: "usuario", zona: "comercial", descripcion: "Altas recibidas desde el formulario público" },
  ...
  { ruta: "/app/aurora", etiqueta: "Aurora", permiso: "reportes:tablero:leer", grupo: "PLATAFORMA", modulo: "plataforma", icono: "usuario", zona: "comercial", descripcion: "Guía en 3D del sistema y su banco de animaciones" },
  { ruta: "/app/aurora/configuracion", etiqueta: "Configurar a Aurora", permiso: "asistente:configuracion:gestionar", grupo: "PLATAFORMA", modulo: "plataforma", icono: "microfono", zona: "comercial", descripcion: "Qué dice el asistente al abrir sesión y con qué voz" },
